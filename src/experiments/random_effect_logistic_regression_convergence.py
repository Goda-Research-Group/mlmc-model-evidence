...
def main():
    ...
    plt.xlim([0,12])
    # save fig
    filename = '../../out/random_effect_logistic_regression/dIWELBO_convergence_{}.pdf'.format(timestamp())
    ...
    plt.xlim([0,12])
    # save fig
    filename = '../../out/random_effect_logistic_regression/dIWELBO_gradients_convergence_{}.pdf'.format(timestamp())
    plt.savefig(filename)
    print("saved the results to:\n {}\n".format(filename))
