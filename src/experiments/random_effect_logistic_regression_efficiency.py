...
parser.add_argument("--output_file", default="../../out/random_effect_logistic_regression/efficiency_{}.csv".format(timestamp()), type=str,
    help="Output file name. \nAn example usage: `python random_effect_logistic_regression_efficiency.py --output_file example.csv`")
...
B = 1000 # batch size. the larger the batch size, the smaller the runtime overhead for SUMO and MLMC.
model = BRELR(D=D)
